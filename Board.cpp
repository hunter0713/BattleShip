...
void Board::printShipSunk()
		{
			...
			cout << "\033[1;31m   .---. .-. .-.,-.,---.      .---. .-. .-..-. .-.,-. .-. \033[0m " << "       _.-^^---....,,--_       " << endl;
			usleep(200000);
			cout << "\033[1;31m ( .-._)| | | ||(|| .-.\\    ( .-._)| | | ||  \\| || |/ / \033[0m " << "     _--                  --_  " << endl;
			usleep(200000);
			cout << "\033[1;31m(_) \\   | `-' |(_)| |-' )  (_) \\   | | | ||   | || | / \033[0m  " << "    <                        >)" << endl;
			usleep(200000);
			cout << "\033[1;31m _  \\ \\  | .-. || || |--'   _  \\ \\  | | | || |\\  || | \\ \033[0m   " << "  |                         | " << endl;
			usleep(200000);
			cout << "\033[1;31m ( `-'  ) | | |)|| || |     ( `-'  ) | `-')|| | |)|| |) \\ \033[0m   " << " \\._                   _./  " << endl;
			usleep(200000);
			cout << "\033[1;31m `----'  /(  (_)`-'/(       `----'  `---(_)/(  (_)|((_)-' \033[0m  " << "    ```--. . , ; .--'''       " << endl;
			usleep(200000);
			cout << "\033[1;31m        (__)      (__)                    (__)    (_)     \033[0m  " << "          | |   |             " << endl;
			cout << "                                                            " << "       .-=||  | |=-.   " << endl;
			cout << "                                                            " << "       `-=#$%&%$#=-'   " << endl;
			cout << "                                                            " << "          | ;  :|     " << endl;
